...
export default function SiliconeSolido() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Silicone Sólido</h1>
          <p className="text-gray-600">Bonecas feitas 100% em silicone sólido.</p>
